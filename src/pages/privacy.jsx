...
export default function Privacy() {
  return (
    <Container fixed>
      <h1>Privacy Policy for IQAC - Instant Q&amp;A Contest</h1>
      <p>At IQAC, accessible from https://iqac.davidday.tw, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by IQAC and how we use it.</p>
      <p>
      ...
      <p>
        ...
        to our websitewith regards to the information that they shared and/or collect in IQAC.
      ...
      <p>
        ...
        the contents of the message and/or attachments you may send us,
      ...
      <p>
        IQAC follows a standard procedure of using log files.
      ...
      <p>
        Like any other website, IQAC uses &apos;cookies&apos;.
      ...
      <p>
        ...
        <a href="https://www.privacypolicyonline.com/what-are-cookies/">&quote;What Are Cookies&quote;</a>
        .
      </p>
      ...
      <p>
        ...
        for each of the advertising partners of IQAC.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective advertisements and links that
        appear on IQAC, which are sent directly to users&apos; browser.
        They automatically receive your IP address when this occurs.
        These technologies are used to measure the effectiveness of theiradvertising campaigns
        and/or to personalize the advertising content that you see on websites that you visit.
      </p>

      <p>
        Note that IQAC has no access to or control over these cookies
      ...
      <p>
        IQAC&apos;s Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        ...
        we have collected to another organization,
      ...
      <p>
        ...
        We encourage parents and guardians to observe,
        participate in, and/or monitor and guide their online activity.
      </p>

      <p>
        IQAC does not knowingly collect any Personal Identifiable Information
